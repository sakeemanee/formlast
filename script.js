...
async function saveToDbJson(endpoint, user) {
  await fetch(`https://github.com/Maneesha-7386/json-server-form.git/${endpoint}`, {
    method: 'POST',
...
signupForm.addEventListener('submit', async function(e) {
  ...
  if (editIndex !== null) {
    ...
    try {
      await fetch(`https://github.com/Maneesha-7386/json-server-form.git/${updatedUser.id}`, {
        method: 'PATCH',
        headers: { 'Content-Type': 'application/json' },
